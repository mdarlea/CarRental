        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("MySQL:AutoIncrement", true),
                    DriverLicenseNumber = table.Column<string>(maxLength: 150, nullable: false),
                    CountryOfIssue = table.Column<string>(maxLength: 150, nullable: false),
                    StateOfIssue = table.Column<string>(maxLength: 150, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name_FirstName = table.Column<string>(maxLength: 150, nullable: false),
                    Name_LastName = table.Column<string>(maxLength: 150, nullable: false),
                    Name_MiddleName = table.Column<string>(maxLength: 150, nullable: true),
